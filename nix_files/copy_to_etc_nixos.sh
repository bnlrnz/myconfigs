...
declare -a NIX_HOME_FILES=(
  ...
  "secrets/nix/webdav_bscw.yaml:secrets/webdav_bscw.yaml"
  "steam.nix"
  "pwn.nix"
  "k3s.nix"
  "temis.nix"
...
declare -a TP_BELO_FILES=(
  ...
  "services.nix"
  "secrets/secrets.yaml:secrets/secrets.yaml"
  "secrets/tp-belo/webdav_bscw.yaml:secrets/webdav_bscw.yaml"
  "secrets/tp-belo/temis_vpn.yaml:secrets/temis_vpn.yaml"
  "secrets/tp-belo/wireguard.yaml:secrets/wireguard.yaml"
  "steam.nix"
  "pwn.nix"
  "k3s.nix"
  "temis.nix"
...
declare -a NIX_VPS_FILES=(
  ...
  ".sops.yaml"
  "secrets/secrets.yaml:secrets/secrets.yaml"
  "secrets/nix-vps/n8n_task_runner_token.yaml:secrets/n8n_task_runner_token.yaml"
...
declare -a NIX_PI_FILES=(
  ...
  "hardware-configuration_nix-pi.nix:hardware-configuration.nix"
  "secrets/secrets.yaml:secrets/secrets.yaml"
)
...
declare -a NIX_TEST_FILES=(
  ...
  "secrets/nix-test/webdav_bscw.yaml:secrets/webdav_bscw.yaml"
  "temis.nix"
)
