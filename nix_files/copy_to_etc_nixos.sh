...
declare -a TP_BELO_FILES=(
  ...
  "services.nix"
  "secrets/secrets.yaml:secrets/secrets.yaml"
  "secrets/tp-belo/webdav_bscw.yaml:secrets/nix/webdav_bscw.yaml"
  "secrets/tp-belo/temis_vpn.yaml:secrets/nix/temis_vpn.yaml"
  "secrets/tp-belo/wireguard.yaml:secrets/tp-belo/wireguard.yaml"
  "steam.nix"
  "pwn.nix"
  "k3s.nix"
  "temis.nix"
...
declare -a NIX_TEST_FILES=(
  ...
  "secrets/nix-test/webdav_bscw.yaml:secrets/nix/webdav_bscw.yaml"
  "temis.nix"
)
